...
<div id="notification-waiting">
    ...
    <div class="col-md-6 col-xs-6">
        ...
        <div class="mr-30 search-box">
            <form action="/action_page.php">
              <input type="text" placeholder="Search.." name="search">
              <button type="submit"><i class="fa fa-search"></i></button>
            </form>
        </div>
        <a href="post.html" class='btn btn-primary txt-dn'>Add a post</a>
...
<div class="col-md-12 col-xs-12">
        <div class="d-flex d-flex-align-center d-flex-justify-end">
        <ol id="FilterPost" class="breadcrumb">
              <li>
                <div class="btn-group">
                    <button type="button" style="font-size: 14px;" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
        ...
        <div id="btnContainer">
          <button class="btn listview active" id="list"><i class="fa fa-bars"></i> List</button> 
          <button class="btn gridview" id="grid"><i class="fa fa-th-large"></i> Grid</button>
        </div>
        </div>
    </div>
</div>
...
<div id="postfilter" class="row row-flex list-group">
    <div class="item col-xs-6 col-lg-4 list-group-item">
         ...
         <div class="card-body">
            ...
            <div class="member-p-block">
               ...
               <div class="profile-member-name">
                  ...
                  <span class="timestamp">Yesterday at 11:00 AM</span>
               </div>
            </div>
    ...
    <div class="card rswall-post">
         <div class="card-body">
            ...
            <div class="post-content-box">
                <div class="post-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                <div class="post-imag-box">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/9VsEAEX6C9Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="post-action-block d-flex d-flex-align-center d-flex-justify-between">
               <div class="d-flex rswall-link">
            ...
            <div class="collapse hidegridview" id="PostComment">
              <div class="post-body">
                ...
                <div class="enterpost">Press Enter to post.</div>
              </div>
            </div>
    ...
    <div class="card rswall-post">
         <div class="card-body">
            ...
            <div class="post-content-box">
                <div class="post-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                <div class="post-imag-box">
                    <img src="sample.gif" alt="" class="img-responsive">
                </div>
            </div>
            <div class="post-action-block d-flex d-flex-align-center d-flex-justify-between">
               <div class="d-flex rswall-link">
